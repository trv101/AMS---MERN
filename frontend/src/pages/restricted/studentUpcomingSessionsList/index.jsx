...
import { viewUpcomingSessionListStudent } from "../../../api/sessionEndPoints";
import { datagridStyles } from "../../../constants/styles";

const StudentUpcomingSessionList = () => {
  const {
    isLoading,
    isError,
    error,
    data: sessionlist,
  } = useQuery("sessionListTeacher", viewUpcomingSessionListStudent);
...
export default StudentUpcomingSessionList;
